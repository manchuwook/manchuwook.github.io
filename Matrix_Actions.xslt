...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:import-schema schema-location="HeroLabCustomExport.xsd"/>
...
//</xsl:comment>
			...
			<body>
				<xsl:element name="div">
					...
					<xsl:element name="div">
						<xsl:attribute name="class">
							<xsl:value-of select="'tabs grid-100'"/>
						</xsl:attribute>
									...
									<xsl:for-each select="character">
										<xsl:element name="input">
											...
											<xsl:attribute name="id">
												<xsl:value-of select="fn:concat('tab-',fn:string-join(for $i in (position())[not(. instance of text() and fn:string-length() eq 0)] return string($i), ' '))"/>
											</xsl:attribute>
										...
										<xsl:element name="div">
											<xsl:attribute name="class">
												<xsl:value-of select="'panel grid-100 actions'"/>
											</xsl:attribute>
											...
											<xsl:element name="div">
												<xsl:attribute name="class">
													<xsl:value-of select="'grid-66 skills'"/>
												</xsl:attribute>
												<xsl:variable name="altova:table">
													<table border="0">
											...
											<xsl:element name="div">
												<xsl:attribute name="class">
													<xsl:value-of select="'grid-33 attributes'"/>
												</xsl:attribute>
												<xsl:variable name="altova:table">
													<table border="0">
				...
				<div style="display:none; " class="grid-container modal-content" id="dice-tower">
					...
					<xsl:element name="div">
						...
						<xsl:attribute name="id">
							<xsl:value-of select="'dice-results'"/>
						</xsl:attribute>
						<xsl:element name="div">
							<xsl:attribute name="class">
								<xsl:value-of select="'grid-40'"/>
							</xsl:attribute>
							<span>
						...
						<xsl:element name="div">
							<xsl:attribute name="class">
								<xsl:value-of select="'grid-20 reroll'"/>
							</xsl:attribute>
							<span>
					...
					<xsl:element name="div">
						...
						<xsl:element name="div">
							...
							<xsl:element name="input">
								<xsl:attribute name="id">
									<xsl:value-of select="'bonus-dice'"/>
								</xsl:attribute>
								<xsl:attribute name="type">
						...
						<xsl:element name="div">
							...
							<xsl:element name="input">
								<xsl:attribute name="id">
									<xsl:value-of select="'penalty-dice'"/>
								</xsl:attribute>
								<xsl:attribute name="type">
									<xsl:value-of select="'text'"/>
								</xsl:attribute>
						...
						<xsl:element name="div">
							<xsl:attribute name="class">
								<xsl:value-of select="'grid-25'"/>
							</xsl:attribute>
							<xsl:element name="input">
								<xsl:attribute name="id">
									<xsl:value-of select="'isPre'"/>
								</xsl:attribute>
								<xsl:attribute name="type">
						...
						<xsl:element name="div">
							...
							<xsl:attribute name="id">
								<xsl:value-of select="'action-roll'"/>
							</xsl:attribute>
							<xsl:attribute name="onclick">
								<xsl:value-of select="'rollDice(6,true)'"/>
							</xsl:attribute>
							<span>
